...
from lmbilstmcrf.ner_dataset import *
...
def construct_bucket_mean_vb_wc(word_features, input_label, label_dict, char_dict, word_dict, caseless):
    ...
    return construct_bucket_vb_wc(word_features, forw_features, fea_len, labels, thresholds, word_dict['<eof>'],
...
def construct_bucket_vb_wc(word_features, forw_features, fea_len, input_labels, thresholds, pad_word_feature,
    ...
    for f_f, f_l, w_f, i_l in zip(forw_features, fea_len, word_features, input_labels):
        ...
        padded_feature_len_cum = list(itertools.accumulate(
